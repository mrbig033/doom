...
(map! :desc "Ag Brain"                :leader "d"     'my-search-ag-brain
      ...
      :desc "Count All"               :leader "cW"    'count-words
...
#+end_src
*** [[file:packages.el::package! evil-smartparens :disable t][Evil Smartparens]] :tno:
...
#+end_src
*** [[file:packages.el::package! evil-swap-keys][Evil Swap Keys]]
#+begin_src emacs-lisp
...
#+end_src
*** [[file:packages.el::package! evil-god-state][Evil God State]] :tno:
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** [[file:packages.el::package! org2blog :disable t][Org2blog]] :tno:
#+begin_src emacs-lisp :tangle no
...
#+end_src
** Files
*** [[file:init.el::treemacs ; a project drawer, like neotree but cooler][Treemacs]] :tno:
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** [[file:init.el::(dired +ranger) ; making dired pretty \[functional\]][Ranger]]
#+begin_src emacs-lisp
(use-package! ranger
  :demand t
  :init
...
#+end_src
*** [[file:packages.el::package! super-save][Super Save]]
#+begin_src emacs-lisp
(use-package! super-save
  ...
  (super-save-mode t))
#+end_src
*** [[file:packages.el::package! git-auto-commit-mode][Git Auto Commit]]
#+begin_src emacs-lisp
...
#+end_src
*** [[file:init.el::pdf ; pdf enhancements][PDF View]]
#+begin_src emacs-lisp
...
#+end_src
*** [[file:packages.el::package! hl-sentence][HL-Sentence]]
#+begin_src emacs-lisp
...
#+end_src
*** [[file:packages.el::package! wordnut][Wordnut]]
#+begin_src emacs-lisp
(use-package! wordnut
  :init
...
(use-package! osx-dictionary
  ...
  (:keymaps '(osx-dictionary-mode-map)
   ...
   "q" 'quit-window))
#+end_src
*** [[file:packages.el::package! typo][Typo]]
#+begin_src emacs-lisp
(use-package! typo
  :config
...
#+end_src
*** [[file:packages.el::package! google-translate][Google Translate]]
#+begin_src emacs-lisp
...
(use-package! markdown-mode
  ...
  (:keymaps     '(markdown-mode-map evil-markdown-mode-map)
   ...
   "M-p"        'my-backward-paragraph-do-indentation))
#+end_src
*** [[file:packages.el::package! pabbrev :disable t][Pabbrev]]
#+begin_src emacs-lisp
(use-package! pabbrev
  :custom
...
#+end_src
*** [[file:packages.el::package! fountain-mode][Fountain Mode]]
#+begin_src emacs-lisp
...
(use-package! flyspell
  ...
  (flyspell-delay 0.2))
#+end_src
*** [[id:1e8083b8-db60-4d34-b5cb-371e1727593a][Company]]
#+begin_src emacs-lisp
(use-package! company
  :custom
...
#+end_src
** Prog
*** [[file:packages.el::package! elpy][Elpy]] :tno:
#+begin_src emacs-lisp :tangle no
(use-package! elpy
  :custom
...
#+end_src
*** [[file:packages.el::package! delight][Delight]]
#+begin_src emacs-lisp
(use-package! delight
  :after-call after-find-file
  :config
...
#+end_src
*** [[file:packages.el::package! eyebrowse][Eyebrowse]]
#+begin_src emacs-lisp
...
#+end_src
*** [[file:packages.el::package! recursive-narrow :disable t][Recursive Narrow]] :inst:
#+begin_src emacs-lisp
(use-package! recursive-narrow
  :init
  (require 'recursive-narrow))
#+end_src
*** [[file:packages.el::package! clipmon :disable t][Clipmon]]
#+begin_src emacs-lisp :tangle no
(use-package! clipmon
  :disabled
  :init
  (clipmon-mode-start))
#+end_src
*** [[file:packages.el::package! engine-mode][Engine]]
#+begin_src emacs-lisp
